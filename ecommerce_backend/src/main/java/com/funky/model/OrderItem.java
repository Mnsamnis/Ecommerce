...
public class OrderItem {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, orderr, price, product, quantity, size, userId);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(id, other.id) && Objects.equals(orderr, other.orderr) && Objects.equals(price, other.price)
